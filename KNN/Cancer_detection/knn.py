...
cancerdata = pd.read_csv(r"C:\Users\Karuna Singh\Downloads\Mar.23\Deployment\KNN_Classifier\cancerdata.csv")
...
engine = create_engine(f"mysql+pymysql://{user}:{pw}@localhost/{db}".format(user = "root", # user
        pw = "WorkBench1",db = 'cancer_db'))
